...
class CitySummaryViewSetTestCase(TestCase):
    def setUp(self):
        ...
        OfficerAllegationFactory.create_batch(4, allegation_category=violation_category, disciplined=True)
        OfficerAllegationFactory.create_batch(3, allegation_category=use_of_force_category, disciplined=True)
        OfficerAllegationFactory.create_batch(2, allegation_category=illegal_search_category, disciplined=False)
