...
from officers.serializers.response_mobile_serializers import (
    ...
    OfficerYearlyPercentileMobileSerializer,
    MobileTimelineSerializer
)


class MobileTimeLineMobileSerializerTestCase(SimpleTestCase):
...
class OfficerYearlyPercentileMobileSerializerTestCase(SimpleTestCase):
    ...
    def test_serialization_missing_percentile(self):
        ...
        expect(OfficerYearlyPercentileMobileSerializer(obj).data).to.eq(expected_response)
