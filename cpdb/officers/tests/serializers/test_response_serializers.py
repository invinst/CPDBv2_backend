...
class OfficerCardSerializerTestCase(TestCase):
...
class PoliceUnitSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        expect(PoliceUnitSerializer(unit_with_name).data).to.eq({
            'id': 123,
            'unit_name': '004',
            'description': 'District 004',
...
class OfficerSummarySerializerTestCase(TestCase):
    def test_serialization(self):
    ...
    def test_get_badge_with_no_current_badge(self):
        ...
        expect(OfficerSummarySerializer(officer).data['badge']).to.eq('')


class OfficerInfoSerializerTestCase(TestCase):
    @patch(
...
class BaseTimelineSerializerSerializerTestCase(TestCase):
    def test_raise_NotImplementedError(self):
        expect(lambda: BaseTimelineSerializer().get_kind(None)).to.throw(NotImplementedError)
        expect(lambda: BaseTimelineSerializer().get_priority_sort(None)).to.throw(NotImplementedError)


class RankChangeNewTimelineSerializerTestCase(TestCase):
    def test_serialization(self):
...
class JoinedNewTimelineSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        expect(JoinedNewTimelineSerializer(officer).data).to.eq({
            'unit_name': 'Unit 001',
            'unit_description': 'District 001',
            'rank': 'Police Officer',
            'priority_sort': 10,
...
class UnitChangeNewTimelineSerializerTestCase(TestCase):
    def test_serialization(self):
        officer = OfficerFactory(id=123)
        unit = PoliceUnitFactory(
            id=4,
...
class AwardNewTimelineSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        expect(AwardNewTimelineSerializer(award).data).to.eq({
            'unit_name': 'Unit 001',
            'unit_description': 'District 001',
            'rank': 'Police Officer',
            'priority_sort': 40,
...
class TRRNewTimelineSerializerTestCase(TestCase):
    def test_serialization(self):
        officer = OfficerFactory(id=123)
        trr = TRRFactory(
            id=456,
        ...
        expect(TRRNewTimelineSerializer(trr).data).to.eq({
            'unit_name': 'Unit 001',
            'unit_description': 'District 001',
            'rank': 'Police Officer',
            'priority_sort': 50,
...
class LawsuitNewTimelineSerializerTestCase(TestCase):
    def test_serialization(self):
        officer = OfficerFactory(id=123)
        ...
        expect(LawsuitNewTimelineSerializer(lawsuit).data).to.eq({
            'unit_name': 'Unit 001',
            'unit_description': 'District 001',
            'rank': 'Police Officer',
            'priority_sort': 50,
...
class OfficerCoaccusalSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        setattr(officer, 'coaccusal_count', 3)
