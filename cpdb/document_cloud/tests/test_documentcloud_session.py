...
class DocumentCloudSessionTestCase(TestCase):
    ...
    def test_request_reprocess_text_success(self, post_mock):
        document = AttachmentFile(
            ...
            url='https://accounts.muckrock.com/documents/documentcloud_id-CRID-234-CR.html'
        )
        ...
        with DocumentCloudSession(self.log_func) as session:
            ...
            expect(post_mock).to.be.called_with(
                'https://accounts.muckrock.com/api/documents/documentcloud_id/process/',
                headers={
            ...
            expect(self.log_func).to.be.called_with(
                '[SUCCESS] Reprocessing text https://accounts.muckrock.com/documents/documentcloud_id-CRID-234-CR.html'
            )
    ...
    def test_request_reprocess_text_failure(self):
        ...
        with patch(
            ...
            expect(post_mock).to.be.called_with(
                'https://accounts.muckrock.com/api/documents/not_exist_documentcloud_id/process/',
                headers={
                    'x-requested-with': 'XMLHttpRequest',
                    'accept': 'application/json, text/javascript, */*; q=0.01'
                }
    ...
    def test_request_reprocess_text_exception(self):
        document = AttachmentFile(
            ...
            url='https://accounts.muckrock.com/documents/exception_documentcloud_id-CRID-234-CR.html'
        )
        ...
        with patch(
            ...
            expect(post_mock).to.be.called_with(
                'https://accounts.muckrock.com/api/documents/exception_documentcloud_id/process/',
                headers={
                    'x-requested-with': 'XMLHttpRequest',
                    'accept': 'application/json, text/javascript, */*; q=0.01'
                }
            ...
            expect(self.log_func).to.be.called_with(
                ...
                'https://accounts.muckrock.com/documents/exception_documentcloud_id-CRID-234-CR.html: Invalid request'
            )
    ...
    def test_request_reprocess_missing_text_documents(self, post_mock, time_mock):
        ...
        expect(post_mock).to.be.any_call(
            'https://accounts.muckrock.com/api/documents/DOCUMENTCLOUD_empty_text_id/process/',
            headers={
                'x-requested-with': 'XMLHttpRequest',
                'accept': 'application/json, text/javascript, */*; q=0.01'
            }
        ...
        expect(post_mock).to.be.any_call(
            'https://accounts.muckrock.com/api/documents/PORTAL_COPA_DOCUMENTCLOUD_empty_text_id/process/',
            headers={
                'x-requested-with': 'XMLHttpRequest',
                'accept': 'application/json, text/javascript, */*; q=0.01'
            }
        ...
        expect(post_mock).to.be.any_call(
            'https://accounts.muckrock.com/api/documents/SUMMARY_'
