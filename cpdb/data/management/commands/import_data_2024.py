...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        try:
            ...
            file_path = "../data-updates/complaints/complaints-complaints.csv"
            call_command('import_complaints_complaints_data_2024', file_path=file_path)

            print("Complaints")
            file_path = "../data-updates/complaints/complainants.csv"
            call_command('import_complaints_data_2024', file_path=file_path)

            print("Complaints Accused")
            file_path = "../data-updates/complaints/complaints-accused.csv"
            call_command('import_complaints_accused_data_2024', file_path=file_path)

            print("Witness")
            file_path = "../data-updates/complaints/civilian_witnesses.csv"
            call_command('import_complaints_data_2024', file_path=file_path)

            print("Investigators")
            file_path = "../data-updates/complaints/investigators.csv"
            call_command('import_investigators_data_2024', file_path=file_path)

            print("Victims")
            file_path = "../data-updates/complaints/victims.csv"
            call_command('import_victims_data_2024', file_path=file_path)

            print("TRR Main")
            file_path = "../data-updates/trrs/trr_main.csv"
