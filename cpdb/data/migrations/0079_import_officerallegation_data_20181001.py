...
def import_data(apps, schema_editor):
    with csv_from_azure('20181001_officerallegation.csv') as reader:
        blank_or_null = {
        ...
        bulk_create_update(OfficerAllegation, rows)


class Migration(migrations.Migration):

    dependencies = [
        ('data', '0078_import_allegationcategory_data_20181001'),
    ]
