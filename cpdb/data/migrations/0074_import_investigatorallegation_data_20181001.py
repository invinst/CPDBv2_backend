...
from data.models import InvestigatorAllegation
...
def import_data(apps, schema_editor):
    with csv_from_azure('20181001_investigatorallegation.csv') as reader:
        blank_or_null = {
        ...
        bulk_create_update(InvestigatorAllegation, rows)


class Migration(migrations.Migration):

    dependencies = [
        ('data', '0073_import_investigator_data_20181001'),
    ]
