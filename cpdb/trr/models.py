...
class TRR(models.Model):
    rd_no = models.CharField(max_length=255, null=True)
    event_no = models.CharField(max_length=255, null=True)
    beat = models.CharField(max_length=255, null=True)
    block = models.CharField(max_length=255, null=True)
    direction = models.CharField(max_length=255, null=True, choices=DIRECTION_CHOICES)
    street = models.CharField(max_length=255, null=True)
    location = models.CharField(max_length=255, null=True)
    trr_datetime = models.DateTimeField()
    indoor_or_outdoor = models.CharField(max_length=255, null=True, choices=INDOOR_OUTDOOR_CHOICES)
    lighting_condition = models.CharField(max_length=255, null=True, choices=LIGHTNING_CONDITION_CHOICES)
    weather_condition = models.CharField(max_length=255, null=True, choices=WEATHER_CONDITION_CHOICES)
    ...
    number_of_weapons_discharged = models.PositiveSmallIntegerField()
    party_fired_first = models.CharField(max_length=255, null=True, choices=PARTY_FIRED_FIRST_CHOICES)
    ...
    subject_gender = models.CharField(max_length=255, null=True, choices=GENDER)
    subject_race = models.CharField(max_length=255, null=True)
    subject_age = models.PositiveSmallIntegerField()
    subject_birth_year = models.CharField(max_length=255, null=True)
