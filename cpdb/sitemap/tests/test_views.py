...
class SitemapViewSetTestCase(TestCase):
    ...
    def test_sitemap_index_view(self):
        ...
        expect(response.content.decode('utf8')).to.eq(
            ...
            '<sitemap><loc>http://example.com/sitemap-static_page.xml</loc></sitemap>'
            '<sitemap><loc>http://example.com/sitemap-officer.xml</loc></sitemap>'
            '<sitemap><loc>http://example.com/sitemap-allegation.xml</loc></sitemap>'
            '<sitemap><loc>http://example.com/sitemap-trr.xml</loc></sitemap>'
            '<sitemap><loc>http://example.com/sitemap-unit.xml</loc></sitemap>'
            '<sitemap><loc>http://example.com/sitemap-attachment.xml</loc></sitemap>\n'
            '</sitemapindex>\n'
        )

    def test_sitemap_static_page_view(self):
        response = self.client.get('/sitemap-static_page.xml')
        expect(response.status_code).to.eq(status.HTTP_200_OK)
        expect(response.content.decode('utf8')).to.eq(
            '<?xml version="1.0" encoding="UTF-8"?>\n'
            ...
            '</url>'
            '<url>'
            '<loc>http://example.com/collaborate/</loc>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
    ...
    def test_sitemap_officer_view(self):
        ...
        expect(response.content.decode('utf8')).to.eq(
            ...
            '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
            '<url>'
            '<loc>http://example.com/officer/456/luke-skywalker/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/officer/123/jerome-finnigan/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/officer/789/kevin-osborn/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>\n'
    ...
    def test_sitemap_allegation_view(self):
        ...
        expect(response.content.decode('utf8')).to.eq(
            ...
            '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
            '<url>'
            '<loc>http://example.com/complaint/456/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/complaint/123/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/complaint/789/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>\n'
    ...
    def test_sitemap_trr_view(self):
        ...
        expect(response.content.decode('utf8')).to.eq(
            ...
            '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
            '<url>'
            '<loc>http://example.com/trr/123/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/trr/456/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/trr/789/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>\n'
    ...
    def test_sitemap_unit_view(self):
        ...
        expect(response.content.decode('utf8')).to.eq(
            ...
            '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
            '<url>'
            '<loc>http://example.com/unit/001/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/unit/002/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/unit/003/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>\n'
    ...
    def test_sitemap_attachment_view(self):
        ...
        expect(response.content.decode('utf8')).to.eq(
            ...
            '<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">\n'
            '<url>'
            '<loc>http://example.com/document/3/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/document/4/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>'
            '<url>'
            '<loc>http://example.com/document/5/</loc>'
            '<lastmod>2019-03-18</lastmod>'
            '<changefreq>daily</changefreq>'
            '<priority>0.5</priority>'
            '</url>\n'
