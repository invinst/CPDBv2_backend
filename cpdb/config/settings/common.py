...
ALLEGATION_MAX = env.str('ALLEGATION_MAX', '2023-07-01')
INTERNAL_CIVILIAN_ALLEGATION_MIN = env.str('INTERNAL_CIVILIAN_ALLEGATION_MIN', '2000-01-01')
INTERNAL_CIVILIAN_ALLEGATION_MAX = env.str('INTERNAL_CIVILIAN_ALLEGATION_MIN', '2022-07-01')
TRR_MIN = env.str('TRR_MIN', '2004-01-08')
TRR_MAX = env.str('TRR_MAX', '2022-04-12')
