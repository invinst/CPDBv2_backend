...
class CRViewSetTestCase(CRTestCaseMixin, APITestCase):
    ...
    def test_retrieve_badge(self):
        ...
        investigator_2 = OfficerFactory(
            ...
            last_name='Finnigan',
            appointed_date=date(2001, 5, 1),
            complaint_percentile=6.62,
            civilian_allegation_percentile=7.72,
            internal_allegation_percentile=8.82,
            allegation_count=1,
            sustained_count=0,
        )
        investigator_3 = OfficerFactory(
            ...
            last_name='May',
            appointed_date=date(2001, 5, 1),
            complaint_percentile=6.63,
            civilian_allegation_percentile=7.73,
            internal_allegation_percentile=8.83,
            allegation_count=1,
            sustained_count=0,
        )
        ...
        expect(dict(response.data)).to.eq({
            ...
            'involvements': [
                ...
                },
                {
                    ...
                    'badge': 'CPD',
                    'percentile_allegation': '6.6200',
                    'percentile_allegation_civilian': '7.7200',
                    'percentile_allegation_internal': '8.8200',
                },
                {
                    'involved_type': 'investigator',
                    'officer_id': 1,
