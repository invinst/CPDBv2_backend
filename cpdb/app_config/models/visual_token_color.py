...
class VisualTokenColor(TimeStampsModel):
    ...
    lower_range = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(100)])
    upper_range = models.FloatField(validators=[MinValueValidator(0), MaxValueValidator(100)])
