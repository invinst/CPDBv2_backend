...
from pinboard.serializers.desktop.relevant.officer_serializer import UnitSerializer, OfficerSerializer
...
class OfficerSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        expect(UnitSerializer(coaccusal).data).to.eq({
            'id': 4,
            'unit_name': '004',
            'description': 'District 004',
        ...
        expect(OfficerSerializer(coaccusal).data).to.eq({
            'id': 11,
