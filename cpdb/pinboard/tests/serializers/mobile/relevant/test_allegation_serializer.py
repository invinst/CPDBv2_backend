...
from pinboard.serializers.mobile.relevant.allegation_serializer import AllegationMobileSerializer
...
class AllegationSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        expect(AllegationMobileSerializer(pinboard.relevant_complaints.first()).data).to.eq({
            'crid': '1',
            'category': 'Operation/Personnel Violations',
