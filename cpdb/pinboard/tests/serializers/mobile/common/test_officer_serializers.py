...
from pinboard.serializers.mobile.common import OfficerRowMobileSerializer, OfficerMobileSerializer


class OfficerRowMobileSerializerTestCase(TestCase):
    def test_serialization(self):
        ...
        serializer = OfficerRowMobileSerializer(officer)
...
class OfficerMobileSerializerTestCase(TestCase):
    def test_serialization(self):
        officer = OfficerFactory(
            id=123,
            first_name='Michael',
        ...
        serializer = OfficerMobileSerializer(officer)
        expect(serializer.data).to.eq({
            'id': 123,
